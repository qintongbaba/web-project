...
public class DatabaseHelper {
     ...
     * @return
     */
    public static <T> List<T> queryEntity(Class<T> entityClass, Map<String, Object>
            fieldMap) {
        List<T> entityList;
        try {
    ...
    public static List<Map<String, Object>> executeQuery(String sql, Object... params) {
        ...
        try {
            Connection conn = getConnection();
            results = QUERY_RUNNER.query(conn, sql, new MapListHandler(), params);
        } catch (SQLException e) {
